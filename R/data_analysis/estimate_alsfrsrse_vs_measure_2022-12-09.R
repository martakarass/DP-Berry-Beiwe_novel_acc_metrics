...
out_df  <- get_lmm_survey_vs_measure(measures_df, y_name, y_label, VAR_NAME_VEC_45angle, VAR_LABEL_VEC_45angle, mod_formula, y_scale, x_scale)
...
fwrite(out_df_all, file.path(here(), "results_tables", "lmm_alsfrsrse_vs_measure_est_withrandomslope_45angle.csv"))
...
y_name = "frs_total_score"
y_label = "ALSFRS-RSE total score"
out_df  <- get_lmm_survey_vs_measure(measures_df, y_name, y_label, VAR_NAME_VEC_90angle, VAR_LABEL_VEC_90angle, mod_formula, y_scale, x_scale)
out_df_all <- rbind(out_df_all, out_df)
...
dim(out_df_all)
table(out_df_all$conv)
fwrite(out_df_all, file.path(here(), "results_tables", "lmm_alsfrsrse_vs_measure_est_withrandomslope_90angle.csv"))
...
y_name = "frs_total_score"
y_label = "ALSFRS-RSE total score"
out_df  <- get_lmm_survey_vs_measure(measures_df, y_name, y_label, VAR_NAME_VEC_135angle, VAR_LABEL_VEC_135angle, mod_formula, y_scale, x_scale)
out_df_all <- rbind(out_df_all, out_df)
...
dim(out_df_all)
table(out_df_all$conv)
fwrite(out_df_all, file.path(here(), "results_tables", "lmm_alsfrsrse_vs_measure_est_withrandomslope_135angle.csv"))
...
dim(out_df_all)
table(out_df_all$conv)
fwrite(out_df_all, file.path(here(), "results_tables", "lmm_alsfrsrse_vs_measure_est_norandomslope_45angle.csv"))
...
y_name = "frs_total_score"
y_label = "ALSFRS-RSE total score"
out_df  <- get_lmm_survey_vs_measure_adj(measures_df, y_name, y_label, var_name_adj, VAR_NAME_VEC_45angle, VAR_LABEL_VEC_45angle, mod_formula, y_scale, x_scale)
out_df_all <- rbind(out_df_all, out_df)
...
dim(out_df_all)
table(out_df_all$conv)
fwrite(out_df_all, file.path(here(), "results_tables", "lmm_alsfrsrse_vs_measure_est_norandomslope_adj_45angle.csv"))
